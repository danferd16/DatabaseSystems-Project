...
<!-- HTML Template used from https://www.mgtechnologies.co.in/product/coza-store-ecommerce-website-template
...
<body class="animsition">
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						if (!empty($_SESSION['cart'])) {
							...
							echo $qty ?>
							<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" onclick="location.href='shoping-cart.php'" data-notify="<?php echo $qty ?>">

						<?php  }else{?>

						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" onclick="location.href='shoping-cart.php'" data-notify="0">
						<?php } ?>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(images/favorites.jpg);">
				...
				<div class="item-slick1" style="background-image: url(images/men.png);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="rotateInUpRight" data-delay="1200">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="images/howto.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="images/howtomen.jpg" alt="IMG-BANNER">
